...
gnome_internet_radio_locator_player_main(gchar *streamuri, gchar *name)
{
	...
	/* } */
	/* else { */
	/*   g_message ("Specify the media file name..<gnome_internet_radio_locator-playerplayer filename>"); */
	/*   return 0; */
	/* } */

	gnome_internet_radio_locator->player_loop = g_main_loop_new (NULL, FALSE);
